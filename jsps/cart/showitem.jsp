...
<c:forEach items="${cartItemList}" var="cartItem">
	<tr align="center">
		<td align="right">
			<a class="linkImage" href="<c:url value='/jsps/book/desc.jsp'/>"><img border="0" width="54" align="top" src="<c:url value='/${cartItem.book.image_b }'/>"/></a>		</td>
		<td align="left">
	...
	<tr>
		<td colspan="6">
			<input id="addr" type="text" name="address" value="广东省 广州市 番禺区 小谷围街道 李先生"/>
		</td>
	</tr>
	<tr>
