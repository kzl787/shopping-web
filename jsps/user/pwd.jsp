  ...
  <body>
	...
	<div class="div1">
		<form action="<c:url value='/UserServlet'/>" method="post" target="_top">
			<input type="hidden" name="method" value="alterpass"/>
		<table>
			<tr>
			...
			<tr>
				...
				<td><input class="input" type="password" name="newpass" id="newpass" value="${form.newpass}"/></td>
				<td><label id="newpassError" class="error">${error.newpass}</label></td>
			</tr>
			<tr>
